...
const Breadcrumbs = ({ card, divider, icon, icons, maxItems, navigation, rightAlign, separator, title, titleBottom, ...others }) => {
    ...
    useEffect(() => {
        // const navItems = { ...navigation, children: getAllowedRoutes(navigation.children, [role]) };

        // console.log('navItems', navItems);
        console.log('navItems', navigation);
        navigation?.items?.map((menu) => {
            if (menu.type && menu.type === 'group') {
                // const protectedMenu = { ...menu, children: getAllowedRoutes(menu.children, [role]) };
                // console.log('protectedMenu', protectedMenu);
                getCollapse(menu);
            }
            return false;
        });
